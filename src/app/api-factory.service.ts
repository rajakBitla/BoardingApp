...
export class ApiFactoryService {
  ...
  getStatistics(){
  const Jsbody={"api_key":"6JBSJ1733LQ7NGG4CMNMDY3ZQOFOG8L8","date":"2024-05-23","is_all_service":true,"order_by":{"occupancy":"1:0","performance":"2:0","revenue":"3:0","schedules_summary_active_cancelled":"4:0","time_blocked_seats_booked_released":"5:0","total_pending_quota_seats":"6:0"},"service_id":"","is_from_middle_tier":true,"locale":"en"};
